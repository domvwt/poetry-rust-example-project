...
.PHONY: clean
clean: clean-build clean-pyc clean-test clean-compiled clean-rust ## remove all build, test, coverage and Python artifacts
...
coverage: ## check code coverage quickly with the default Python
	-coverage run --source python -m pytest python/tests
	coverage report -m
	coverage html
